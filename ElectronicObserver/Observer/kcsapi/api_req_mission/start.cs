	...
	public class start : APIBase
	{
		...
		public override void OnRequestReceived(Dictionary<string, string> data)
		{
			...
			*/
			...
			Utility.Logger.Add(2, string.Format("#{0}「{1}」", deckID, KCDatabase.Instance.Fleet[deckID].Name), "已开始远征",
				string.Format("「{0}: {1}」。",destination, KCDatabase.Instance.Mission[destination].Name));
