namespace ElectronicObserver.Window.Dialog {
	partial class DialogAlbumMasterEquipment {
		...
		private void InitializeComponent() {
			...
			this.StripMenu_File_OutputCSVUser.Text = "导出 CSV ( 阅览用途 )(&U)...";
			...
			this.StripMenu_File_OutputCSVData.Text = "导出 CSV ( 数据用途 )(&D)...";
			...
			this.StripMenu_View_ShowAppearingArea.Text = "搜索当前装备的初期装备舰 / 开发配方(&S)";
			...
			this.TitleAircraftCost.Text = "配置消耗";
