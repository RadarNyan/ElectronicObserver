	...
	public partial class DialogBaseAirCorpsSimulation : Form {
		...
		private class SquadronUI {
			...
			private static string GetAircraftParameters( EquipmentDataMaster eq ) {
				...
				Add( "装甲", eq.Armor );
				Add( "对潜", eq.ASW );
				Add( isLand ? "迎击" : "回避", eq.Evasion );
				Add( "索敌", eq.LOS );
				Add( isLand ? "对爆" : "命中", eq.Accuracy );
				AddNoSign( "配置消耗", eq.AircraftCost );
				AddNoSign( "行动半径", eq.AircraftDistance );
		...
		private class BaseAirCorpsUI {
			...
			public BaseAirCorpsUI( int baseAirCorpsID, DialogBaseAirCorpsSimulation parent ) {
				...
				TitleAircraftCategory.Text = "机种";
				TitleAircraft.Text = "配置飞机";
				TitleAircraftCount.Text = "机数";
				TitleAirSuperioritySortie.Text = "出击制空";
				TitleAirSuperiorityAirDefense.Text = "防空制空";
				TitleDistance.Text = "行动半径";
				TitleBomber.Text = "爆装";
				TitleTorpedo.Text = "雷装";
				TitleOrganizationCost.Text = "配置消耗";
				TitleAutoAirSuperiority.Text = "目标制空";
				TitleAutoDistance.Text = "目标半径";

				TitleAircraftCategory.Font = Utility.Configuration.Config.UI.MainFont;
				TitleAircraft.Font = Utility.Configuration.Config.UI.MainFont;
				TitleAircraftCount.Font = Utility.Configuration.Config.UI.MainFont;
				TitleAirSuperioritySortie.Font = Utility.Configuration.Config.UI.MainFont;
				TitleAirSuperiorityAirDefense.Font = Utility.Configuration.Config.UI.MainFont;
				TitleDistance.Font = Utility.Configuration.Config.UI.MainFont;
				TitleBomber.Font = Utility.Configuration.Config.UI.MainFont;
				TitleTorpedo.Font = Utility.Configuration.Config.UI.MainFont;
				TitleOrganizationCost.Font = Utility.Configuration.Config.UI.MainFont;
				TitleAutoAirSuperiority.Font = Utility.Configuration.Config.UI.MainFont;
				TitleAutoDistance.Font = Utility.Configuration.Config.UI.MainFont;
				...
				AutoAirSuperiorityMode.Font = Utility.Configuration.Config.UI.MainFont;
				...
				AutoOrganizeSortie.Text = "出击编成";
				AutoOrganizeSortie.Font = Utility.Configuration.Config.UI.MainFont;
				...
				AutoOrganizeAirDefense.Text = "防空编成";
				AutoOrganizeAirDefense.Font = Utility.Configuration.Config.UI.MainFont;
			...
			void AutoOrganize_Click( object sender, EventArgs e ) {
				...
				if ( orgs == null || orgs.All( o => o == null ) ) {
					MessageBox.Show( "自动编成失败。\r\n可能是设置的条件过于严苛、或可用飞机不足。\r\n",
						"自动编成失败", MessageBoxButtons.OK, MessageBoxIcon.Error );
					return;
				}
		...
		private void DialogBaseAirCorpsSimulation_Load( object sender, EventArgs e ) {
			...
			if ( !KCDatabase.Instance.BaseAirCorps.Any() ) {
				MessageBox.Show( "还没有获取过基地航空队数据。\r\n请点击一次出击 ( 到海域选择画面 ) 。", "尚未获取基地航空队数据",
