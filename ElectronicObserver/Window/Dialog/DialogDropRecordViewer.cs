	...
	public partial class DialogDropRecordViewer : Form
	{
		...
		private void RecordView_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
		{
			...
			try
			{
				...
				{
					StatusInfo.Text = "找不到对应的战斗日志文件。";
					return;
				}

				StatusInfo.Text = "正在查找战斗日志文件…";
				...
				StatusInfo.Text = string.Format("打开战斗日志文件 : {0}", Path.GetFileName(battleLogFile));
