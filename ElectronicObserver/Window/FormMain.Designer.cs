namespace ElectronicObserver.Window {
	partial class FormMain {
		...
		private void InitializeComponent() {
			...
			this.StripMenu_File_Layout_Load.Text = "读取(&L)";
			...
			this.StripMenu_File_Layout_Open.Text = "打开布局文件(&O)...";
			...
			this.StripMenu_File_Layout_Change.Text = "保存布局文件(&C)...";
			...
			this.StripMenu_File_Layout_LockLayout.Text = "锁定布局(&T)";
			...
			this.StripMenu_File_Layout_TopMost.Text = "窗口置顶(&M)";
			...
			this.StripMenu_View_Compass.Text = "罗盘(&C)";
			...
			this.StripMenu_WindowCapture_AttachAll.Text = "捕获所有窗口(&S)";
			...
			this.StripMenu_Tool_ResourceChart.Text = "资源图表(&C)";
			...
			this.StripMenu_Debug_LoadAPIFromFile.Text = "从文件载入 API(&L)...";
			...
			this.StripMenu_Debug_LoadInitialAPI.Text = "载入 API 列表(&I)...";
			...
			this.StripMenu_Debug_LoadRecordFromOld.Text = "从旧的 api_start2 读取记录(&O)...";
			...
			this.StripMenu_Debug_DeleteOldAPI.Text = "删除旧 API 数据(&D)";
			...
			this.StripMenu_Debug_RenameShipResource.Text = "重命名舰船列表(&R)...";
			...
			this.StripMenu_Debug_LoadDataFromOld.Text = "从旧的 api_start2 读取深海栖舰(&A)...";
